...
function Signup() {
    ...
    const formSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                toast.success("Registration successful! Moving to login page...", { theme: "dark" });
                setTimeout(() => navigate('/login'), 2000); // Wait before navigating
                setFormValues({
                    name: "",
                    mob_num: "",
                    email: "",
                ...
                toast.error(errorData.message || "Registration failed. Please try again.", { theme: "dark" });
            }
        } catch (error) {
                            ...
                            <div className="card p-2">
                                ...
                                <form onSubmit={formSubmit} className="form-group">
                                    ...
                                    <div className="btn btn-block my-3 text-capitalize text-light" onClick={login}>
                                        <img src="img/Google.png" alt="google" className='img-fluid me-2' />Sign Up With Google
                                    </div>
                                </form>

                                <div className="d-flex my-3">
                                    <p>Already have an account?</p> 
                                    <Link to="/login" className="ps-2 text-light text-decoration-underline">Log in </Link>
                                </div>
                            </div>
                        </div>
                    </div>
